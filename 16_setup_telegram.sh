...
echo ""
echo "    /opt/odoo/venv/bin/python /opt/odoo/src/odoo/odoo-bin -c /etc/odoo/odoo.conf -d company_ai -i ai_telegram_bridge --stop-after-init"
echo ""
...
echo "     (ir.config_parameter, via the Odoo shell - use the pinned"
echo "     /opt/odoo/venv/bin/python interpreter first):"
echo ""
echo "         /opt/odoo/venv/bin/python /opt/odoo/src/odoo/odoo-bin shell -c /etc/odoo/odoo.conf -d company_ai <<'EOF'"
