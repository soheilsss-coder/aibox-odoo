...
class AiFileJob(models.Model):
    ...
    def enqueue(self,attachment,question=""):
        ...
        return self.create({"name":attachment.name,"attachment_id":attachment.id,"mime_type":attachment.mimetype or mimetypes.guess_type(attachment.name)[0],"sha256":digest,"result_json":json.dumps({"question":question})})
