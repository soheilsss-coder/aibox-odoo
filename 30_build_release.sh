...
python3 -m compileall -q custom_addons tests 48_auto_integration_certification.py 60_v58_llm_benchmark.py 61_v58_capacity_gate.py 62_v58_module_certification.py 63_v58_rag_acl_benchmark.py
python3 -m unittest discover -s tests -v
python3 60_v58_llm_benchmark.py --help >/dev/null
python3 61_v58_capacity_gate.py --help >/dev/null
python3 63_v58_rag_acl_benchmark.py --help >/dev/null
